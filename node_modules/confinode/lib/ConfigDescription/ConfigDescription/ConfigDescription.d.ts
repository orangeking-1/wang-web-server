 ...
 */
export declare type DynamicConfigDescription<T> = () => ConfigDescription<T>;
/**
 * A configuration description parameter can be either static or dynamic.
 */
export declare type ConfigDescriptionParameter<T> = ConfigDescription<T> | DynamicConfigDescription<T>;
/**
 ...
 */
export declare function asDescription<T>(description: ConfigDescriptionParameter<T>): ConfigDescription<T>;
